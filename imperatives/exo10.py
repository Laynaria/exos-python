...
phrase = f"Bonjour, je m'appelle {prenom.capitalize()}, j'ai {age:04d} ans, je suis né le {date_naissance:%B %d %Y}."

print(phrase)
print(phrase == "Bonjour, je m'appelle Bobby, j'ai 0030 ans, je suis né le May 26 1992.")